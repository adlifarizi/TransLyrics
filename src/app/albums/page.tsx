...
async function AlbumList() {
    ...
    try {
        ...
        const res = await fetch(`${backendApiUrl}/albums?sort_by=title&direction=asc`,
            { cache: 'no-store' }
        );
        ...
        const getAlbumsBySection = (letter: string) => {
            ...
            return albums
                .filter((album: any) => album.title.charAt(0).toUpperCase() === letter)
                ...
                <div className="space-y-8">
                    ...
                    <div id="section-#" className="scroll-mt-24">
                        ...
                        {getAlbumsBySection("#").length > 0 ? (
                            ...
                            <p className="text-gray-500">No album available at this time</p>
                        )}
                    </div>
